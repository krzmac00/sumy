...
import os
# Ustawienie ścieżki do GDAL na poziomie ustawień Django
...
SECRET_KEY = "django-insecure-u9@4=tb@n)@e_b9103x)3=%o9a-xqvm5hh(rb#jy0_v$vp^h!x"
...
DATABASES = {
    'default': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis',  # For PostGIS support
        'NAME': 'postgres',
        'USER': 'postgres',
        'PASSWORD': 'postgres',
